...
The easiest way to learn how to use Molehill Chemical Calculator is to jump right in with some examples.  HINT: Move this window to one side of the Chemical Calculator so that you can read this and enter data at the same time.  
